param(
  [string]$TenantId = "e0e1f74a-a300-42c6-a65c-917c4befb560",
    [string]$ClientId = "5eddb292-b9ed-41ec-b2c4-86709925e9aa",
    [string]$ClientSecret = "WGu8Q~2_uKWSTKbwaIMbppFeLB6ycAUK4TZHbaK0",
    [string]$Scope = "api://404be116-6db5-481a-9974-56709134adb5/.default",
    [string]$ApiUrl = "https://ResurgemusTokenTest.resurgemus.xyz/api/data/competitors",
